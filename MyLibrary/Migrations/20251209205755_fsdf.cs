        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OutstandingFees = table.Column<decimal>(type: "decimal(24,13)", precision: 24, scale: 13, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LateFee = table.Column<bool>(type: "bit", nullable: false),
                    StatusstatusBorrowTransaction = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BorrowTransaction", x => x.TransactionId);
                    table.ForeignKey(
                        name: "FK_BorrowTransaction_Book_BookId",
                        column: x => x.BookId,
                        principalTable: "Book",
                        principalColumn: "BookId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BorrowTransaction_Member_MemberId",
                        column: x => x.MemberId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FineId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TransactionId = table.Column<int>(type: "int", nullable: false),
                    Amount = table.Column<decimal>(type: "decimal(24,13)", precision: 24, scale: 13, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Fine_BorrowTransaction_TransactionId",
                        column: x => x.TransactionId,
                        principalTable: "BorrowTransaction",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BorrowTransaction_BookId",
                table: "BorrowTransaction",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_BorrowTransaction_MemberId",
                table: "BorrowTransaction",
                column: "MemberId");
